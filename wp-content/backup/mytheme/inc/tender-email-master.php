...
<html>
  <head>
    <meta charset="utf-8">
    <title>Nepalbolpatra.com (<?php date("Y-m-j") ?>)</title>
        ...
        <tbody>
          <tr class="first-row">
            ...
            <td><?php if ($tender_each['image']) { ?>
              <a href="<?php echo wp_upload_dir()['baseurl'] . '/' . $tender_each['image']; ?>" target="_blank">
                <img src="<?php echo wp_upload_dir()['baseurl']; ?>/<?php echo $tender_each['image']; ?>" title="tender" alt="View" style="max-height: 50px; max-width: 100px; display:block;">
              </a>
            <?php } else { ?>
              &nbsp;n/a
            <?php } ?></td>
