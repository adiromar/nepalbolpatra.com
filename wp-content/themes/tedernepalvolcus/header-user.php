...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url') ?>/assets/css/user.css" />
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
      ...
      <a class="navbar-brand" href="<?php echo home_url() ?>">ELAGANI</a>
  <?php endif; ?>
    </div>
	<div class="collapse navbar-collapse" id="myNavbar" style="margin-left: -11px;">
      <ul class="nav navbar-nav">
        ...
        <?php endif; ?>
	        ...
	        <!-- <li><a href="<?php echo home_url( '/sharebazaar' ) ?>"><img src="<?php bloginfo('template_url') ?>/assets/images/arrow.png" width="25" height="20">  SHARE BAZAAR</a></li> -->
				<?php endif; ?>
				<?php if ( is_super_admin() ): ?>
					<li>
					<div class="dropdown">
      ...
      <!-- <div class="member_area">
      	...
      	<!-- <p id="signin_mod_link" data-toggle="modal" data-target="#myModal" onclick="show_login();return false;">SIGN IN</p>
				...
				<p class="pull-right" style="margin-top: 10px;"><a href="<?php echo home_url( '/?action=login' ) ?>" style="color: white; font-size: 16px;">SIGN IN</a></p>
      </div>
			<?php else : ?>
				<div class="member_area">
  ...
  <div class="modal-dialog" role="document">
		<div class="login tab_content_login" id="tab1_login" style="display: block;">
			<form id="accesspanel" action="<?php bloginfo('url') ?>/wp-login.php" method="post" style="height:360px; margin-top:20px; width: 300px;">
				...
				<div class="inset">
				  <p>
				    <input id="textinput" style="margin-left: -5px; width: 250px;" type="text" name="log" id="email" placeholder="Email address" value="<?php echo (isset($user_login)) ? esc_attr(stripslashes($user_login)) : ''; ?>" required >
				  </p>
				  <p>
