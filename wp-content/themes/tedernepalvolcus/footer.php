...
<div id="contact" class="footer" style="margin-top: 50px; width: 100%;">
    <div class="container">
        <div class="row">
             <div class="col-md-4">
                <div class="hm-ft-contact ">
                    ...
                    <ul class="list-unstyled">
                      <li>Located at Subidhanagar, Tinkune, Kathmandu</li>
                      <li>Mobile No. : 9851064219</li>
                      <!-- <li>Phone No. : 01-4456785</li> -->
                      <!-- <li>Fax No. : 01-4456785</li> -->
                      <li>E-mail : <a href="#">encoderslab@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4" style="text-align: center;padding-top:50px;">
                ...
                <iframe width="100%" height="180px" frameborder="0" class="img-rounded" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=27%C2%B040'53.4%22N%2085%C2%B020'39.4%22E&key=AIzaSyDoeLpv9KO_0XGTTHZresQC6kOdVEo0wXc" allowfullscreen></iframe>
            	</div>
            </div>
